...
<script>
  ...
  return str.replace(
	...
	// document.querySelector('#bio iframe').src = 'https://my.forrest-zeng.github.io/Forrest-Zeng-ASB/api/v1/bio/display?name=' + encodeURIComponent(name.toLowerCase().split(' ').join(''));
	fetch('https://my.forrest-zeng.github.io/Forrest-Zeng-ASB/api/v1/bio?name=' + encodeURIComponent(name)).then(bio => bio.json()).then(bio => {
            console.log(bio);
            bioOpen = true;
